...
/**
 ** \file /home/lajna/code/BTH/DV1656/assignment3/generated/parser.tab.hh
...
#ifndef YY_YY_HOME_LAJNA_CODE_BTH_DV1656_ASSIGNMENT3_GENERATED_PARSER_TAB_HH_INCLUDED
# define YY_YY_HOME_LAJNA_CODE_BTH_DV1656_ASSIGNMENT3_GENERATED_PARSER_TAB_HH_INCLUDED
// "%code requires" blocks.
#line 7 "/home/lajna/code/BTH/DV1656/assignment3/parser.yy"
...
#line 57 "/home/lajna/code/BTH/DV1656/assignment3/generated/parser.tab.hh"
...
namespace yy {
#line 192 "/home/lajna/code/BTH/DV1656/assignment3/generated/parser.tab.hh"
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::list<Node*>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::list<Node*>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_LESS_THAN (std::string v, location_type l)
      {
        return symbol_type (token::LESS_THAN, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_LESS_THAN (const std::string& v, const location_type& l)
      {
        return symbol_type (token::LESS_THAN, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_GREATER_THAN (std::string v, location_type l)
      {
        return symbol_type (token::GREATER_THAN, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_GREATER_THAN (const std::string& v, const location_type& l)
      {
        return symbol_type (token::GREATER_THAN, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::SUBTRACT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::SUBTRACT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::MULTIPLY, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::MULTIPLY, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::LEFT_BRACE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::LEFT_BRACE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::RIGHT_BRACE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::RIGHT_BRACE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LEFT_PARENTHESIS (std::string v, location_type l)
      {
        return symbol_type (token::LEFT_PARENTHESIS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_LEFT_PARENTHESIS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::LEFT_PARENTHESIS, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHT_PARENTHESIS (std::string v, location_type l)
      {
        return symbol_type (token::RIGHT_PARENTHESIS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_RIGHT_PARENTHESIS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::RIGHT_PARENTHESIS, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LEFT_BRACKET (std::string v, location_type l)
      {
        return symbol_type (token::LEFT_BRACKET, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_LEFT_BRACKET (const std::string& v, const location_type& l)
      {
        return symbol_type (token::LEFT_BRACKET, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHT_BRACKET (std::string v, location_type l)
      {
        return symbol_type (token::RIGHT_BRACKET, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_RIGHT_BRACKET (const std::string& v, const location_type& l)
      {
        return symbol_type (token::RIGHT_BRACKET, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_SYSTEM_OUT_PRINTLN (std::string v, location_type l)
      {
        return symbol_type (token::SYSTEM_OUT_PRINTLN, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_SYSTEM_OUT_PRINTLN (const std::string& v, const location_type& l)
      {
        return symbol_type (token::SYSTEM_OUT_PRINTLN, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 2358 "/home/lajna/code/BTH/DV1656/assignment3/generated/parser.tab.hh"




#endif // !YY_YY_HOME_LAJNA_CODE_BTH_DV1656_ASSIGNMENT3_GENERATED_PARSER_TAB_HH_INCLUDED
