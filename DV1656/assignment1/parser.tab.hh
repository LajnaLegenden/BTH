  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_INTEGER_LITERAL = 24,                  // INTEGER_LITERAL
        S_COMMENT = 25,                          // COMMENT
        S_LESS_THAN = 26,                        // LESS_THAN
        S_GREATER_THAN = 27,                     // GREATER_THAN
        S_EQUAL = 28,                            // EQUAL
        S_ADD = 29,                              // ADD
        S_SUBTRACT = 30,                         // SUBTRACT
        S_MULTIPLY = 31,                         // MULTIPLY
        S_DIVIDE = 32,                           // DIVIDE
        S_LENGTH = 33,                           // LENGTH
        S_LEFT_BRACE = 34,                       // LEFT_BRACE
        S_RIGHT_BRACE = 35,                      // RIGHT_BRACE
        S_LEFT_PARENTHESIS = 36,                 // LEFT_PARENTHESIS
        S_RIGHT_PARENTHESIS = 37,                // RIGHT_PARENTHESIS
        S_LEFT_BRACKET = 38,                     // LEFT_BRACKET
        S_RIGHT_BRACKET = 39,                    // RIGHT_BRACKET
        S_DOT = 40,                              // DOT
        S_SEMICOLON = 41,                        // SEMICOLON
        S_ASSIGN = 42,                           // ASSIGN
        S_PLUSOP = 43,                           // PLUSOP
        S_MINUSOP = 44,                          // MINUSOP
        S_MULTOP = 45,                           // MULTOP
