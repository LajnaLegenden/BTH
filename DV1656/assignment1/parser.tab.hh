...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    LEFT_PARENTHESIS = 286,        // LEFT_PARENTHESIS
    RIGHT_PARENTHESIS = 287,       // RIGHT_PARENTHESIS
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_GREATER_THAN = 22,                     // GREATER_THAN
        S_EQUAL = 23,                            // EQUAL
        S_ADD = 24,                              // ADD
        ...
        S_DIVIDE = 27,                           // DIVIDE
        S_LENGTH = 28,                           // LENGTH
        S_LEFT_BRACE = 29,                       // LEFT_BRACE
        S_RIGHT_BRACE = 30,                      // RIGHT_BRACE
        S_LEFT_PARENTHESIS = 31,                 // LEFT_PARENTHESIS
        S_RIGHT_PARENTHESIS = 32,                // RIGHT_PARENTHESIS
        S_LEFT_BRACKET = 33,                     // LEFT_BRACKET
        S_RIGHT_BRACKET = 34,                    // RIGHT_BRACKET
        S_DOT = 35,                              // DOT
        S_COMMA = 36,                            // COMMA
        S_SEMICOLON = 37,                        // SEMICOLON
        S_ASSIGN = 38,                           // ASSIGN
        S_IDENTIFIER = 39,                       // IDENTIFIER
        S_INTEGER_LITERAL = 40,                  // INTEGER_LITERAL
        S_STATIC = 41,                           // STATIC
        S_RETURN = 42,                           // RETURN
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_ERROR (std::string v)
      {
        return symbol_type (token::ERROR, std::move (v));
      }
#else
      static
      symbol_type
      make_ERROR (const std::string& v)
      {
        return symbol_type (token::ERROR, v);
      }
#endif
